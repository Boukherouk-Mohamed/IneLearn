    ...
    <div className="middleCoursesPage">
      <div className="leftCoursespage" id="leftCoursespage">
         <h1 style={{textAlign: 'center', fontSize: '20px'}}>Javascript courses</h1>
            ...
            <Link to="/Course4" className='selectedPage' >JS Statements</Link>
      ...
      <div className="rightCoursesSide" id="rightCoursesSide">
        ...
        <p>A computer program is a list of "instructions" 
        to be "executed" by a computer.


        TIn a programming language, these programming instructions
         are called statements.and changes the e
